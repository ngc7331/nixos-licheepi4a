...
# nixos-licheepi4a:
# modified from https://github.com/NixOS/nixpkgs/blob/fa42801050c1d56f70c783cf5f43fd79f3ab542a/pkgs/development/libraries/gobject-introspection/wrappers/g-ir-scanner-qemuwrapper.sh
# added args to emulator to enable xthead vendor extension
...
exec @emulator@ @emulatorargs@ ${GIR_EXTRA_OPTIONS:-} \
